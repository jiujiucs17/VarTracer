...
output_folder = '/Users/zhangmengqi/Documents/PhD/Working Documents/Deliverable 2/dataflow analysis and tool development/tool evaluation experiment/Pilot_Study_6'
print("Comparing execution stacks...")
exec_stack_json_1_path = output_folder + "/exec_stack" + "/exec_stack_task_12_1.json"
exec_stack_json_0_path = output_folder + "/exec_stack" + "/exec_stack_task_12_0.json"
dep_tree_json_1_path = output_folder + "/dependency" + "/dep_tree_task_12_1.json"
dep_tree_json_0_path = output_folder + "/dependency" + "/dep_tree_task_12_0.json"
